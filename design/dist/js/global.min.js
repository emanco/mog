var fixto = function(a, b, c) {
    ...
    function e() {
        ...
        return b.appendChild(d), b.style[n] = "translate(0)", b.style.marginTop = "10px", 
        b.style.visibility = "hidden", d.style.position = "fixed", d.style.top = 0, c.body.appendChild(b), 
        d.getBoundingClientRect().top > 0 && (a = !0), c.body.removeChild(b), a;
    }
    function f(b, c, d) {
    ...
    var i = function() {
        ...
        }, c.documentElement.getBoundingClientRect().width || (b.prototype._width = b.prototype._widthOffset, 
    ...
    q && (l = parseFloat(navigator.appVersion.split("MSIE")[1])), f.prototype = {
        ...
        _onscroll: function() {
            ...
            !1 !== this.options.mindBottomPadding && (this._parentBottom -= i.getFloat(this.parent, "paddingBottom")), 
            !this.fixed && this._shouldFix()) this._fix(), this._adjust(); else {
        ...
        _isViewportAvailable: function() {
            ...
            return this._viewportHeight > this.child.offsetHeight + i.toFloat(a.marginTop) + i.toFloat(a.marginBottom);
        },
        _adjust: function() {
            var a = 0, b = this._mindtop(), c = 0, d = i.getAll(this.child), e = null;
            k && (e = this._getContext()) && (a = Math.abs(e.getBoundingClientRect().top)), 
        ...
        _getContext: function() {
            for (var a, b, d = this.child, e = null; !e; ) {
                if ((a = d.parentNode) === c.documentElement) return null;
    ...
    var r = function(a, b, c) {
        return o && !c || o && c && !1 !== c.useNativeSticky ? new h(a, b, c) : p ? (void 0 === k && (k = e()), 
...
!function(a) {
    a(document).on("click", "[data-pnp-toggle-class]", function() {
        return a(a(this).data("pnp-target")).toggleClass(a(this).data("pnp-class")), a(this).toggleClass(a(this).data("pnp-class")), 
        !1;
    }), a(document).on("click", ".accordion .trigger", function(b) {
        var c = a(this).closest(".accordion").first().find(".reveal").first();
        a(this).hasClass("active") ? (c.slideUp(300), a(this).removeClass("active")) : (c.slideDown(300), 
        a(this).addClass("active"));
    }), a(document).on("click", ".component-card-order:not(.-in)", function() {
        return a(window).outerWidth() < 992 && a(".right-panel").fadeIn(), !1;
    }), a(document).on("click", "[data-pnp-back]", function() {
        return a(".right-panel").fadeOut(), !1;
    }), a("#mog-breadcrumb").fixTo("body");
}(jQuery);